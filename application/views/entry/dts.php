                	...
                	<div class="row" style="padding-left: 15px;">
                		<div class="col-xs-6">
                			<div class="form-group">
  								...
  								<input type="text" class="form-control" id="testercode" name="testercode" width="70%" placeholder="Enter Tester Code" list="code-list" autocomplete="off"/>
	                	...
	                	<div class="col-xs-6">
	                		<div class="form-group">
		      							...
		      							<input type="text" class="form-control" id="form_serial" name="form_serial" placeholder="Form Serial" autocomplete="off" required />
    									</div>
                						...
                						<div>
                							<table class="table table-condensed" width="90%">
                								...
                								<tr>
                									...
                									<td>
                										<input type="date" name="dod" id="dod" class="form-control" max="<?php echo date('Y-m-d');?>">
                									</td>
                								</tr>
                								<tr>
                									<th>Date Recieved:(at site)</th>
                									<td>
                										<input type="date" name="dsr" id="dsr" class="form-control" max="<?php echo date('Y-m-d');?>">
                									</td>
                								</tr>
                								<tr>
                								...
                								<tr>
                									...
                									<td>
                										<input type="date" name="dtsr" id="dtsr" class="form-control" max="<?php echo date('Y-m-d');?>">
                									</td>
                								</tr>
                								<tr>
                									<th>Date/Time Tested:</th>
                									<td>
                										<input type="date" name="dtst" id="dtst" class="form-control" max="<?php echo date('Y-m-d');?>">
                									</td>
                								</tr>
                								<tr>
                			...
                			<div>
                				<table class="table table-condensed table-bordered">
                					<tr>
                						...
                						<th width="12%">Date</th>
                						<td width="12%"><input type="date" name="testingDate" id="testingDate" class="form-control" max="<?php echo date('Y-m-d');?>"></td>
                					</tr>
                					<tr>
...
if($(this).val()>5000){
	...
	$("#syphscreening").prop("disabled",true);
	$("#syphscreeninglot").prop("disabled",true);
	$("#syphscreeningexpdate").prop("disabled",true);
	$("#syphpanel1fr").prop("disabled",true);
	$("#syphpanel2fr").prop("disabled",true);
	$("#syphpanel3fr").prop("disabled",true);
	$("#syphpanel4fr").prop("disabled",true);
}
else{
	$("#hivsyp").prop("checked",true);
	$("#syphscreening").prop("disabled",false);
	$("#syphscreeninglot").prop("disabled",false);
	$("#syphscreeningexpdate").prop("disabled",false);
	$("#syphpanel1fr").prop("disabled",false);
	$("#syphpanel2fr").prop("disabled",false);
	$("#syphpanel3fr").prop("disabled",false);
	$("#syphpanel4fr").prop("disabled",false);
}

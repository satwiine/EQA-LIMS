...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="row">
      ...
      <a href="<?php echo base_url('getDRJsonResult');?>" class="btn btn-primary btn-sm">Import Result</a>
      <br> <br>
      <!-- end the check -->
      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <table id="manageTable" class="table table-bordered table-hover table-striped">
            <thead>
                <tr>
                    <th>Eligible Sampleid</th>
                    <th>Patient ART No</th>
                    <th> Sex </th>
                    <th>Birth Date</th>
                    <th>Facility</th>
                    <th>Date of Collection</th>
                    <th>DR Lab Sampleid</th>
                    <th>Date Sample Recieved</th>
                    <th>TAT Status</th>
                    <th>Action</th>
                </tr>
            </thead>
...
<script type="text/javascript">
  ...
  manageTable =$('#manageTable').DataTable({
    ...
    'ajax': base_url+'fetchUnresultedSample',
    'order':[]
  });

...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="row">
      ...
      <?php 
          if($_SESSION['usercat']==1 || $_SESSION['usercat']==6 || $_SESSION['usercat']==3 || $_SESSION['usercat']==19){
            ?>
            <a href="<?php echo base_url('addTester');?>" class="btn btn-primary btn-sm">Add Tester</a>
            <div class="col-sm-4 pull-right"><a href="<?php echo base_url('bulkUpdate');?>" class="btn btn-primary btn-sm">Bulk Update</a></div>
            <?php
          }
      ?>
      <br> <br>
          ...
          <table id="manageTable" class="table table-bordered table-hover table-striped">
            <thead>
              <tr>
                ...
                <th width="10%">Tester Name</th>
                <th width="5%">Cadre </th>
                <th width="15%">Faciliity</th>
                <th width="5%">Sitecode</th>

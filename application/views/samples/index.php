...
<div class="content-wrapper">
	...
	<section class="content">
		...
		<div class="row">
			...
			<button class="btn btn-primary" data-toggle="modal" data-target="#addModal">Add Facility</button>
...
<div class="modal fade" tabindex="-1" role="dialog" id="addModal">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form role="form" action="<?php echo base_url('createElement');?>" method="post" id="createForm">

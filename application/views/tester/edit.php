...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      ...
      <?php //print_r($tester);exit(); ?>

    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">Edit Tester</li>
    </ol>
  </section>
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <form role="form" action="<?php echo base_url('updateTester') ?>" method="post">
              <div class="box-body">
                	...
                	<div class="row" style="padding-left: 15px;">
                		<div style="margin:auto; width: 30%; padding: 10px;">
                			<div class="form-group">
  												...
  												<input type="text" class="form-control" id="tcode" name="tcode" width="50%" value="<?php echo $tester['tcode'];?>" autocomplete="off"/ disabled>
  												<input type="hidden" class="form-control" id="testercode" name="testercode" value="<?php echo $tester['tcode'];?>" autocomplete="off"/>
  								
											</div>
											<div class="form-group">
  												<label for="testername">Tester Name:</label>  
  												<input type="text" class="form-control" id="testername" name="testername" width="50%" value="<?php echo $tester['TesterName'];?>" autocomplete="off"/>
											...
											<div class="form-group">
  												...
  												<input type="text" class="form-control" id="contacts" name="contacts" width="50%" value="<?php echo $tester['contacts']; ?>" autocomplete="off"/>

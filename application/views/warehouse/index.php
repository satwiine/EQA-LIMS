...
<div class="modal fade" tabindex="-1" role="dialog" id="addModal">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form role="form" action="<?php echo base_url('createWarehouse');?>" method="post" id="createForm">
				<div class="modal-body">
					<div class="form-group">
						<label for="warehouse_name">Warehouse</label>
						<input type="text" class="form-control" id="warehouse_name" name="warehouse_name" placeholder="Enter Warehouse name" autocomplete="off">
					</div>
					<div class="form-group">
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form role="form" action="<?php echo base_url('editWarehouse');?>" method="post" id="updateForm">
				<div class="modal-body">
					<div class="form-group">
						<label for="edit_warehouse_name">Elements Name</label>
						<input type="text" class="form-control" id="edit_warehouse_name" name="edit_warehouse_name" placeholder="Enter warehouse name" autocomplete="off">
					</div>
					<div class="form-group">
						<label for="edit_warehouse_status">Status</label>
						<select class="form-control" id="edit_warehouse_status" name="edit_warehouse_status">
							<option value="1">Active</option>
							<option value="0">In-Active</option>
						</select>
					</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		manageTable = $('#manageTable').dataTable({
			...
			'ajax':base_url+'getWarehouseData',
			'order':[]
		});
	...
	function editFunc(id){
		//var base_url="<?php echo base_url();?>";
		$.ajax({
			url: base_url+'/getWarehouseDataById/'+id,
			type: 'post',
			dataType:'json',
			success:function(response){
			//	alert(response.name);
				$('#edit_warehouse_name').val(response.name);
				$('#edit_warehouse_status').val(response.status);

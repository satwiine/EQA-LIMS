    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <form role="form" action="<?php echo base_url('saveFacility') ?>" method="post">
              <div class="box-body">
                ...
                <div class="panel panel-info">
                	<div class="panel-heading">
                		<span style="margin: 0 auto; display: table;">EQA (PT) PROFICIENCY TESTING SCHEME: New Facility</span>
                	</div>
                	<div class="row" style="padding-left: 15px;">
                		<div style="margin:auto; width: 30%; padding: 10px;">
                			<div class="form-group">
  												<label for="testercode">Sitecode Code:</label>  
  												<input type="text" class="form-control" id="sitecode" name="sitecode" width="50%" value="<?php echo $sitecode['sitecode'];?>" autocomplete="off"/>
  								
											</div>
											<div class="form-group">
  												<label for="testername">Facility Name:</label>  
  												<input type="text" class="form-control" id="facilityname" name="facilityname" width="50%" placeholder="Enter Facility Name" autocomplete="off"/>
											...
											<div class="form-group">
  												...
  												<input type="text" class="form-control" id="location" name="location" width="50%" placeholder="Enter Facility Location" autocomplete="off"/>
  								
											</div>

											<div class="form-group">
  												<label for="division">Facility division:</label>  
  												<input type="text" class="form-control" id="division" name="division" width="50%" placeholder="Enter Facility Division" autocomplete="off"/>
  								
											</div>
												<div class="box-footer">
					                <button type="submit" class="btn btn-primary">Save Changes</button>
					                <a href="<?php echo base_url('manageFacility/') ?>" class="btn btn-danger">Back</a>
					              </div>
	                	</div>		                	
                	</div>
                </div>    

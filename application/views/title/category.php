...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>Manage Title Categories</h1>
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i>Home</a></li>
			<li class="active">Title Category</li>
		</ol>
	</section>
	...
	<section class="content">
		...
		<div class="row">
			...
			<button class="btn btn-primary" data-toggle="modal" data-target="#addModal">Add Cateory</button>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		manageTable = $('#manageTable').dataTable({
			...
			'ajax':base_url+'fetchTitleCategory',
			'order':[]
		});

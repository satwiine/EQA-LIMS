	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i>Home</a></li>
				<li class="active"> Item Reciept</li>
		</ol>
	</section>
		...
		<!-- Select category -->
				<div class="row">
					<div class="col-md-12 col-xs-12">
						...
						?>
					<div class="box">
						<form role="form" action="<?php echo base_url('stockItems');?>" method="post" class="form-horizontal" id="createForm">
							<div class="box-body">
								...
								<div class="col-md-7 col-xs-12 pull pull-left">
									...
									<div class="form-group">
										<label for="rxfrom" class="col-sm-5 control-label" style="text-align: left;">Date Recieved</label>
										<div class="col-sm-7">
											<input type="date" name="recieptdate" id="recieptdate" class="form-control" value="<?php echo date('Y-m-d');?>" max="<?php echo date('Y-m-d');?>">
										</div>
									</div>
									<div class="form-group">
										<label for="rxfrom" class="col-sm-5 control-label" style="text-align: left;">Recieved From</label>
										<div class="col-sm-7">
											<input type="text" name="rxfrom" id="rxfrom" placeholder="Recieved From" class="form-control" autocomplete="off" required>
										</div>
									</div>
                  ...
                  Description" autocomplete="off">
								...
								<table class="table table-bordered" id="product_info_table">
									...
									<tbody>
										<tr id="row_1">
											...
											<td>
												<input type="number" name="qty[]" id="qty_1" class="form-control" required="required">
											</td>
											<td>
												<label id="exp_label_1"></label>
												<input type="hidden" name="expires[]" id="expires_1" class="form-control" value="0">
											</td>
											<td>
												<input type="date" name="exp_dt[]" id="exp_dt_1" class="form-control">
											</td>
											<td>
												<select class="form-control select_group product" data-row-id="row_1" id="warehouse_1" name="warehouse[]" style="width: 100%" onchange="getWarehouseData(1)" required="required">
													<?php echo $warehouse;
													?>
												</select>
											</td>
							...
							<div class="box-footer">
								<button type="submit" class="btn btn-success">Recieve Items</button>
			...
			var row_id = count_table_tbody_tr+1;
 			$.ajax({
				...
				success: function(response){
					...
					html +='</select>'+
					'</td>'+
					'<td><input type="number" name="qty[]" id="qty_'+row_id+'" class="form-control" required="required"></td>'+
					'<td><label id="exp_label_'+row_id+'"></label> <input type="hidden" name="expires[]" id="expires_'+row_id+'" class="form-control" value="0"></td>'+
					'<td><input type="date" name="exp_dt[]" id="exp_dt_'+row_id+'" class="form-control"> </td>'+
					'<td><select class="form-control select_group product" data-row-id="row_"'+row_id+'" id="warehouse_"'+row_id+'" name="warehouse[]" style="width: 100%" required="required"><?php echo $warehouse;?></td>'+
